...
// Validación para serial: letras, números, guiones, guiones bajos
const serialValido = e => {
    // Permite: A-Z, a-z, 0-9, guiones (-), guiones bajos (_)
...
document.getElementById("serial").addEventListener("blur", function() {
    if (this.value.length > 0 && this.value.length < 5) {
        this.classList.add('campo-error');
        mostrarNotificacion("El serial debe tener al menos 5 caracteres", 'warning');
    }
});
